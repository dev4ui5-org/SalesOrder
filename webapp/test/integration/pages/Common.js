sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/sample/SalesOrder/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.sample.SalesOrder.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/sample/SalesOrder/localService/mockserver"], function (mockserver) {
